                ...
                <div class="text-center my-4">
                    ...
                    <div class="py-2">
                        ...
                        <div class="inline-flex text-gray-700 items-center">
                            ...
                            <br>
                            @if($user->musicianType)
                                <p>Muzikant Type: {{ $user->musicianType->name }}</p>
                            @else
                                <p>Deze gebruiker heeft geen muziek type gedefineerd.</p>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="px-4 py-4">
                ...
                <div class="flex">
                    <div class="flex justify-end mr-2">
                        <img class="border-2 border-white rounded-full h-10 w-10 -mr-2"
                        ...
                        <span
                            class="flex items-center justify-center bg-white text-sm text-gray-800 font-semibold border-2 border-gray-200 rounded-full h-10 w-10">+999</span>
                    </div>
                </div>
            </div>
        </div>
