<x-guest-layout>
    ...
    <div class="w-full flex flex-wrap">
        ...
        <div class="w-1/2 shadow-2xl">
            <img class="object-cover w-full h-screen hidden md:block" src="https://studyworkgrow.com.au/wp-content/uploads/2021/03/Music-Therapist-JS-1024x576.png" alt="Background" />
        </div>
    </div>
</x-guest-layout>
